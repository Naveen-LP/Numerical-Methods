...
integer :: nnn,i
real,dimension(:),allocatable :: x,k,k2,uo,uoo
real :: h,l,dx,alpha,dk,pi,z,t,left,right,dt,j
...
!uoo(2*i-1) = uo(2*i-1)*(1 - (alpha*k2(2*i-1)*dt))

!end do

!call four1(uoo,nnn,1)

!uoo(1) = left*nnn
!uoo(2*nnn-1) = right*nnn
